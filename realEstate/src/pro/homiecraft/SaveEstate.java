...
public class SaveEstate {
	...
	public static void estateSave(String sMin, String sMax, String name, String owner, String pName, String price, String cWorld, double x, double y, double z){
		...
		if (saveType == true){
			...
			EstateConfig.getEstateConfig("estates").set("Estate." + name + ".world", cWorld);
